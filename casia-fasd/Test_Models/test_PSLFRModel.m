function test_PSLFRModel(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, method)
...
load(strcat('..\Train_Models\PSModels_RBF', modelname, '_', method, '.mat'));

% Load thrsholds for computing HTER
load(strcat('..\Develop_Models\PerSpecPerf_RBF_devel', modelname, '_', method, '.mat'));
...
save(strcat('PerSpecPerf_RBF_crosstest', modelname, '_', method, '.mat'), 'Perf');
