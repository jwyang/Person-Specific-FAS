function test_PSModels_specific_quality(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, Quality_Type_train, Quality_Type_test, method)
...
load(strcat('..\Train_Models\PSModels_noOutlier_', name{Feat_Type}, '_', method, '_', suffix, '.mat'));

% Load thrsholds for computing HTER
load(strcat('..\Develop_Models\PerSpecPerf_noOutlier_devel_', name{Feat_Type}, '_', method,  '_', suffix, '_', Quality_Type_test,'.mat'));
...
save(strcat('PerSpecPerf_test_', name{Feat_Type}, '_', method, '_', suffix, '_', Quality_Type_test, '.mat'), 'Perf');
