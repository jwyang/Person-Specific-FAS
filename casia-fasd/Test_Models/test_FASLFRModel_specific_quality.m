function test_FASLFRModel_specific_quality(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, Quality_Type_train, Quality_Type_test, method)
...
load(strcat('..\Develop_Models\FASPerf_devel', modelname, '_', method, '_', suffix, '_', Quality_Type_test, '.mat'));
...
save(strcat('FASPerf_crosstest', modelname, '_', method, '.mat'), 'Perf');
