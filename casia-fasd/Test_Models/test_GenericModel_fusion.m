function test_GenericModel_fusion(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type)
...
if exist(strcat('..\Train_Models\GenericModel', modelname))
    load(strcat('..\Train_Models\GenericModel', modelname));
    model = GenericModel;
...
load(strcat('..\Develop_Models\GenericPerf_devel', modelname));
...
save(strcat('GenericPerf_test',modelname), 'Perf');
