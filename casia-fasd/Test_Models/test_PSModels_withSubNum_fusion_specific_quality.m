function test_PSModels_withSubNum_fusion_specific_quality(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, Quality_Type_train, Quality_Type_test, method)
...
load(strcat('..\Develop_Models\PerSpecPerf_devel_withSubNum', modelname, '_', method, '_', suffix, '_', Quality_Type_test, '.mat'));
...
save(strcat('PerSpecPerf_test_withSubNum', modelname, '_', method, '_', suffix, '_', Quality_Type_test, '.mat'), 'Perf');
