function test_GenericModel(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type)
...
% ---------------- train SVM model ---------------- %
if exist(strcat('..\Train_Models\GenericModel_RBF_', name{Feat_Type}, '.mat'))
    load(strcat('..\Train_Models\GenericModel_RBF_', name{Feat_Type}, '.mat'));
    model = GenericModel;
...
load(strcat('..\Develop_Models\GenericPerf_RBF_devel_', name{Feat_Type}, '.mat'));
...
save(strcat('GenericPerf_RBF_test_', name{Feat_Type}, '.mat'), 'Perf');
