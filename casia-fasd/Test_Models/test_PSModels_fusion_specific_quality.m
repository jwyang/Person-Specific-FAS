function test_PSModels_fusion_specific_quality(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, Quality_Type_train, Quality_Type_test, method)
...
save(strcat('PerSpecPerf_test', modelname, '_', method, '_', suffix, '_', Quality_Type_test, '.mat'), 'Perf');
