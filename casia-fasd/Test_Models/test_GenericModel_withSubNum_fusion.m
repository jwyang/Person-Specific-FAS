function test_GenericModel_withSubNum_fusion(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type)
...
if exist(strcat('..\Train_Models\GenericModel_withSubNum', modelname))
    load(strcat('..\Train_Models\GenericModel_withSubNum', modelname));
    model = GenericModel;
...
load(strcat('..\Develop_Models\GenericPerf_devel_withSubNum', modelname));
...
save(strcat('GenericPerf_test_withSubNum',modelname), 'Perf');
