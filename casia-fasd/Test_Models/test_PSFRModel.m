function test_PSFRModel( Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, Quality_Type_train, Quality_Type_test, method)
...
load(strcat('..\Train_Models\PSFRModel_noSynth', modelname, '_', method, '.mat'));
...
save(strcat('FRPerf_test', modelname, '_', method, '.mat'), 'FRLabels');
