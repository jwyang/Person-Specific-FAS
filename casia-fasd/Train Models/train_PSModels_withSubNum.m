function train_PSModels_withSubNum(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, method)
...
for q = 1:3
    VirtualFeatures{q} = load(strcat('..\Domain_Adaptation\SynthFeatures_AllTSubs_withSubNum_', QualityTypes_Fake{q}, '_', name{Feat_Type}, '_', method));
end
...
for SubNum = 1:SUB_NUM_S
    for s = SUB_NUM_S+1:SUB_NUM
        samples_data = VirtualFeatures{1}.SynthFeatures_AllTSubs{s-SUB_NUM_S, SubNum};
        samples_data = [samples_data; VirtualFeatures{2}.SynthFeatures_AllTSubs{s-SUB_NUM_S, SubNum}];
        samples_data = [samples_data; VirtualFeatures{3}.SynthFeatures_AllTSubs{s-SUB_NUM_S, SubNum}];
