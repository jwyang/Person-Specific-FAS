function train_GenericModel(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type)
...
for t = 0
    for c = 100
        ...
        % ---------------- train SVM model ---------------- %
        if exist(strcat('GenericModel_RBF_', name{Feat_Type}, '.mat'))
            load(strcat('GenericModel_RBF_', name{Feat_Type}, '.mat'));
            model = GenericModel;
            break;
        else
...
if ~exist(strcat('GenericModel_RBF_', name{Feat_Type}, '.mat'))
    GenericModel = model;
    save(strcat('GenericModel_RBF_', name{Feat_Type}, '.mat'), 'GenericModel');
end
