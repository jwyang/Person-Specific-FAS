function train_GenericModel_withSubNum_specific_quality(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, Quality_Type, method)
...
% if ~exist(strcat('GenericModel_withSubNum_', name{Feat_Type}, '_', method, '_', suffix, '.mat'))
