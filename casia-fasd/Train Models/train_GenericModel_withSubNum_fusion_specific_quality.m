function train_GenericModel_withSubNum_fusion_specific_quality(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, Quality_Type, method)
...
save(strcat('GenericModel_withSubNum', modelname, '_', method, '_', suffix, '.mat'), 'GenericModel');
