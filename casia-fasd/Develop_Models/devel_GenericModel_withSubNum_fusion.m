function devel_GenericModel_withSubNum_fusion(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type)
...
save(strcat('GenericPerf_devel_withSubNum', modelname, '.mat'), 'Perf');
