function devel_GenericModel_fusion_specific_quality(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, Quality_Type_train, Quality_Type_dev, method)
...
% L2 Normalize feature vectors, has normalized them before
...
% ---------------- train SVM model ---------------- %
if exist(strcat('..\Train_Models\GenericModel', modelname, '_', method, '_', suffix, '.mat'))
    load(strcat('..\Train_Models\GenericModel', modelname, '_', method, '_', suffix, '.mat'));
    model = GenericModel;
...
save(strcat('GenericPerf_devel', modelname, '_', method, '_', suffix, '_', Quality_Type_dev, '.mat'), 'Perf');

clear samples_data_fld_train;
clear samples_label_fld_train;

% if ~exist(strcat('GenericModel_', modelname, '.mat'))
%     GenericModel = model;
%     save(strcat('GenericModel_', modelname, '.mat'), 'GenericModel');
% end
