function devel_PSModels_withSubNum_fusion_specific_quality(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, Quality_Type_train, Quality_Type_dev, method)
...
load(strcat('..\Train_Models\PSModels_withSubNum', modelname, '_', method, '_', suffix, '.mat'));
...
%     if PSModels{s, SubNum}.totalSV == 0
%         i = SubNum + 1;
%         while(1)
%             if PSModels{s, i}.totalSV > 0
%                 PSModels{s, SubNum} = PSModels{s, i};
%                 break;
%             else
%                 i = i + 1;
%             end
...
save(strcat('PerSpecPerf_devel_withSubNum', modelname, '_', method, '_', suffix, '_', Quality_Type_dev, '.mat'), 'Perf');
