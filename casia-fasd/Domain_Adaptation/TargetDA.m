function TargetDA(Feats_train_SL, Labels_train_SL, Feats_test_SL, Labels_test_SL, Feat_Type, QualityType, method)
...
%        end
    ...
    % if ~strcmp(QualityType, 'HN')
        SynthFeatures_AllTSubs{n-SUB_NUM_S} = SynthFeatures_TSub(1:SUB_NUM_S:end, :);
    % else
    %    SynthFeatures_AllTSubs{n-SUB_NUM_S} = SynthFeatures_TSub(1:end, :);
    % end        
end

save(strcat('SynthFeatures_AllTSubs_noOutlier_', QualityType, '_', name{Feat_Type}, '_', method), 'SynthFeatures_AllTSubs', '-v7.3');
