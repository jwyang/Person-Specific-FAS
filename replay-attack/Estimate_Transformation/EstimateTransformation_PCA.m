function EstimateTransformation_PCA(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, Feat_Type, BLabel, method)
...
for i = 1:SUB_NUM_S
    ...
    s = s(1);
    samples_data_allsubjects = [samples_data_allsubjects; samples_data_subjects{s}];
end
...
Transform.weights = samples_weight_subjects;
Transform.mean  = samples_data_allsubjects_mean;
