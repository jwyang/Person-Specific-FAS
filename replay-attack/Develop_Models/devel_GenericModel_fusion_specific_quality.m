function devel_GenericModel_fusion_specific_quality(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, Feat_Type, method)
...
for s = 1:SUB_NUM
    ...
    % L2 Normalize feature vectors, the feature vector have been normalized before
...
save(strcat('GenericPerf_devel', modelname, '_', method, '_', suffix, '.mat'), 'Perf');
