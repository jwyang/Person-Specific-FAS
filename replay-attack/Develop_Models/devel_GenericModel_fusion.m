function devel_GenericModel_fusion(Feats_train_SL, Labels_train_SL,  Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, Feat_Type)
...
% L2 Normalize feature vectors, the feature vectors have been normalized before
...
Perf.HTER_overall = EER;
Perf.HTER_persub  = HTERs;
Perf.Threshold    = threshold;
save(strcat('GenericPerf_devel', modelname, '.mat'), 'Perf');
