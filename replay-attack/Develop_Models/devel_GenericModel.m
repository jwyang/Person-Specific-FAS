function devel_GenericModel(Feats_train_SL, Labels_train_SL,  Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, Feat_Type)
...
save(strcat('GenericPerf_devel_', name{Feat_Type}, '.mat'), 'Perf');
