function train_GenericModel_withSubNum_fusion(Feats_train_SL, Labels_train_SL,  Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, Feat_Type)
...
if ~exist(strcat('GenericModel_withSubNum', modelname, '.mat'))
    save(strcat('GenericModel_withSubNum', modelname, '.mat'), 'GenericModel');
end
