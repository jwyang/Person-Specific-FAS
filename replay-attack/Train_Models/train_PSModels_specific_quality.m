function train_PSModels_specific_quality(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, ...
...
for i = 1:SUB_NUM_T
    ...
    samples_data = [];
    for q = 1:length(VirtualFeatures)
        samples_data = [samples_data; VirtualFeatures{q}.SynthFeatures_AllTSubs{i}];
    end    
...
if exist(strcat('PSModels_', name{Feat_Type}, '_', method, '_', suffix, '.mat'))
    load(strcat('PSModels_', name{Feat_Type}, '_', method, '_', suffix, '.mat'));
end
...
save(strcat('PSModels_noNorm_', name{Feat_Type}, '_', method, '_', suffix, '.mat'), 'PSModels');
end
