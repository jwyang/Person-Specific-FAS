function train_PSModels_fusion_specific_quality(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, ...
...
for i = 1:SUB_NUM_T
    ...
    for q = 1:size(VirtualFeatures, 1)
        ...
        for k = 1:size(VirtualFeatures, 2)
            ...
            data = VirtualFeatures{q, k}.SynthFeatures_AllTSubs{i};
            if isempty(data)
                break;
            end
