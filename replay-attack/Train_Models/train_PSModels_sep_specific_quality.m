function train_PSModels_sep_specific_quality(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, ...
...
for i = 1:SUB_NUM_T
    ...
    for b = 1:length(BType)
    for q = 1:length(QualityType)
        samples_data = [samples_data; VirtualFeatures{q, b}.SynthFeatures_AllTSubs{i}];
    end    
    end
...
save(strcat('PSModels_Sep_', name{Feat_Type}, '_', method, '_', suffix, '.mat'), 'PSModels');
end
