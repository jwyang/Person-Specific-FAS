function test_GenericModel_withSubNum(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, Feat_Type)
...
load(strcat('..\Develop_Models\GenericPerf_devel_withSubNum_', name{Feat_Type}, '.mat'));
...
save(strcat('GenericPerf_test_withSubNum_', name{Feat_Type}, '.mat'), 'Perf');
