function test_PSModels(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, Feat_Type, method)
...
load(strcat('..\Train_Models\PSModels_', name{Feat_Type}, '_', method, '.mat'));

% Load thrsholds for computing HTER
load(strcat('..\Develop_Models\PerSpecPerf_devel_', name{Feat_Type}, '_', method, '.mat'));
...
save(strcat('PerSpecPerf_test_', name{Feat_Type}, '_', method, '.mat'), 'Perf');
