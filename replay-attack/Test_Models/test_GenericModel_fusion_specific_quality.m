function test_GenericModel_fusion_specific_quality(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, Feat_Type, method)
...
load(strcat('..\Develop_Models\GenericPerf_devel', modelname, '_', method, '_', suffix, '.mat'));
...
save(strcat('GenericPerf_test', modelname, '_', method, '_', suffix, '.mat'), 'Perf');
