function test_FRModels(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, Feat_Type)
...
load(strcat('..\Train_Models\FRModel_', name{Feat_Type}, '.mat'));
...
save(strcat('FRPerf_test_', name{Feat_Type}, '.mat'), 'FRLabels');
