function test_PSModels_fusion(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, Feat_Type, method)
...
load(strcat('..\Develop_Models\PerSpecPerf_devel', modelname, '_', method, '.mat'));
...
save(strcat('PerSpecPerf_test', modelname, '_', method, '.mat'), 'Perf');
