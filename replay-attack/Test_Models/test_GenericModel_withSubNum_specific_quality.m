function test_GenericModel_withSubNum_specific_quality(Feats_train_SL, Labels_train_SL, Feats_devel_SL, Labels_devel_SL, Feats_test_SL, Labels_test_SL, ...
    Feat_Type, method)
...
save(strcat('GenericPerf_test_withSubNum_', name{Feat_Type}, '_', method, '_', suffix, '.mat'), 'Perf');
